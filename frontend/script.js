...
const MODEL_CATALOG = [
    {
        ...
        description: 'Primary high-reasoning model for architecture, planning, and multi-step analysis when the router needs stronger depth.',
    ...
    },
    {
        ...
        description: 'Reliable code generation and failover target that keeps the product responsive when stronger models are unavailable or slow.',
        role: 'Code / Failover',
        costLabel: 'Moderate',
    },
    {
        ...
        description: 'Fast mid-tier reasoning model used for ambiguous prompts, safe fallbacks, and user-facing clarification responses.',
    ...
    },
    {
        ...
        description: 'Budget general-purpose path for lightweight responses when the router does not need heavy reasoning.',
        role: 'Cheap General',
        costLabel: 'Low',
    },
    {
        ...
        description: 'Ultra-low-cost model for simple math, direct factual lookups, and very short prompts.',
        role: 'Cheap Factual',
        costLabel: 'Very Low',
    },
    {
        ...
        description: 'Used only for ambiguous prompts when uncertainty crosses the routing threshold. Returns structured task + complexity JSON.',
